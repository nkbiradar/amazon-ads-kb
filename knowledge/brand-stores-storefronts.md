...
sources:
  - url: "https://advertising.amazon.com/solutions/products/stores"
    type: official
    confidence: high
topic_id: brand-stores-storefronts
---

# Amazon Brand Stores and Storefronts
...
Brand Stores are customizable, multi-page brand destinations on Amazon that allow brands to:
...
### Brand Building
- Establish dedicated brand presence on Amazon
...
2. **Choose store template** from available options
...
### Template Options
Amazon provides multiple templates with different layouts:
...
- Home pages with featured content
...
- Product categories by type/use case
...
### Traffic Sources
Drive traffic to your Brand Store through:
...
- Store visitor traffic and sources
...
- Use intuitive menu organization
...
### Holiday Strategy
- Create seasonal store pages
- Highlight holiday-specific products
...
- Feature launches prominently on homepage
...
- Images: High-resolution, consistent styling
...
- [Sponsored Brands](sponsored-brands-guide.md)
