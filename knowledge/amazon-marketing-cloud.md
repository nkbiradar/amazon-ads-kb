...
sources:
  - url: "https://advertising.amazon.com/solutions/products/amazon-marketing-cloud"
    type: official
    confidence: high
topic_id: amazon-marketing-cloud
---

# Amazon Marketing Cloud Data Clean Room
...
AMC provides advertisers with a comprehensive solution for:
...
AMC uses AWS Clean Rooms technology to enable:
...
AMC integrates with other Amazon systems:
...
AMC enables comprehensive measurement while maintaining customer privacy through:
...
- Cross-channel planner for media allocation
...
AMC ensures data security through:
...
2. **Integrate event-level data** from various platforms
...
### Enhanced Targeting
AMC insights can improve Amazon DSP performance through:
...
- Better budget allocation through insights
