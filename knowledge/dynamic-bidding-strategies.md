...
sources:
  - url: "https://advertising.amazon.com/library/guides/dynamic-bidding-sponsored-products"
    type: official
    confidence: high
topic_id: dynamic-bidding-strategies
---

# Dynamic Bidding Strategies and Optimization
...
Dynamic bidding uses machine learning and real-time signals to:
- Automatically adjust bids for individual auctions
...
- Evaluates each auction opportunity
...
1. **Start with Down Only** for gradual optimization
...
### Budget Requirements
Dynamic bidding campaigns need:
- Sufficient daily budget for bid increases
...
Combine dynamic bidding with:
- Search top bid adjustments
...
### Starting with Dynamic Bidding
- Begin with established campaigns
- Ensure sufficient conversion history
...
### Learning Period
Dynamic bidding requires time to:
- Learn campaign performance patterns
...
- Before/after dynamic bidding implementation
...
### Performance Issues
If dynamic bidding underperforms:
- Ensure sufficient learning period completed
...
- Budget limitations constraining optimization
...
- [Campaign Optimization](campaign-optimization-techniques.md)
